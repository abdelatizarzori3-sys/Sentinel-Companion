...
async function sendCompanionMessage() {
  ...
  try {
    const response = await fetch(`${CONFIG.API_BASE}/api/chat/stream`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ messages: Companion.messages, locale: Companion.locale, context: Companion.weather }), signal: Companion.controller.signal });
